...
const ReceiptModal = ({ editReceiptModal, editReceiptDataModal, setReceiptDataModal }) => {
  ...
  // useEffect(() => {
  //   if (editReceiptDataModal) {
  //     getReceiptById();
  //   } else {
  //     // Reset receiptData when modal is closed
  //     setReceiptData(null);
  //   }
  ...
  return (
    <>
      <Modal size="lg" isOpen={editReceiptDataModal}>
        <ModalHeader>
          Receipt Details
          <Button
                ...
                <Col md="4">
                  <FormGroup>
                    ...
                    <Input
                      ...
                      name="creation_date"
                      value={receiptData && moment(receiptData.creation_date).format('YYYY-MM-DD')} // Format the date using moment
