  ...
  const GetPdf = () => {
    const dd = {
      ...
      content: [
        ...
        {
          text: `This Employment Agreement dated  ${
            employeeDetails.act_join_date ? employeeDetails.act_join_date : ''
          } is made between\n\n`,
          style: 'textSize',
          fontSize: 10,
        },
        {
          ...
          }(hereinafter referred to as "the employer") with its business operating address located at\n\n`,
          style: 'textSize',
          fontSize: 10,
        },
        {
        ...
        {
          text: `1.1	Your employment shall commence on  ${
            employeeDetails.act_join_date ? employeeDetails.act_join_date : ''
          }\n\n\n`,
          fontSize: 10,
          style: 'textSize',
        ...
        {
          text: ` ${
            employeeDetails.duty_responsibility ? employeeDetails.duty_responsibility : ''
          }\n\n`,
          style: 'textSize',
          fontSize: 10,
        },
        ...
        {
          text: `4.1	Your monthly basic salary shall be $ ${
            employeeDetails.basic_pay ? employeeDetails.basic_pay : ''
          } per month as fixed allowance.\n\n`,
          style: 'textSize',
          fontSize: 10,
        },
        ...
        {
          text: `5.1	Working Days.  The Company working days shall be ${
            employeeDetails.working_days ? employeeDetails.working_days : ''
          } days work week. \n\n`,
          style: 'textSize',
          fontSize: 10,
        },
        ...
        {
          text: `THIS AGREEMENT SIGNED ON THIS ${
            employeeDetails.act_join_date ? employeeDetails.act_join_date : ''
          }\n\n\n\n\n\n\n`,
          style: 'textSize',
          fontSize: 10,
